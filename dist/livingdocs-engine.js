...
module.exports = ComponentModel = (function() {
  ...
  ComponentModel.prototype.inlineData = function(arg) {
    var changedDataProperties, name, ref, value;
    if (typeof arg === 'object') {
      changedDataProperties = [];
      for (name in arg) {
        value = arg[name];
        if (this.changeInlineData(name, value)) {
          changedDataProperties.push(name);
        }
      }
      if (changedDataProperties.length > 0) {
      ...
      return this.dataInlineStyles[arg];
    } else {
      return this.dataInlineStyles;
    }
  };

  ComponentModel.prototype.setInlineData = function(key, value) {
    var ref;
    if (key && this.changeInlineData(key, value)) {
      return (ref = this.componentTree) != null ? ref.dataChanging(this, [key]) : void 0;
    }
  };

  ComponentModel.prototype.getInlineData = function(key) {
    if (key) {
      return this.dataInlineStyles[key];
    } else {
      return this.dataInlineStyles;
    }
  };

  ComponentModel.prototype.changeInlineData = function(name, value) {
    if (deepEqual(this.dataInlineStyles[name], value)) {
      return false;
    }
    this.dataInlineStyles[name] = value;
    return true;
  };
...
module.exports = ComponentView = (function() {
  ...
  ComponentView.prototype.updateData = function() {
    var hyperlink;
    hyperlink = this.model.dataValues['hyperlink'];
    if (hyperlink) {
      this.setHyperlink(hyperlink);
      this.stripHtmlIfReadOnly();
    }
  };

  ComponentView.prototype.updateInlineStylesData = function() {
    var property, ref, value;
    ref = this.model.dataInlineStyles;
    for (property in ref) {
      value = ref[property];
      this.setCssStyle(this, this.model.template.styles[property]['cssProp'], value, this.model.template.styles[property]['defaultValue'], this.model.template.styles[property]['unit']);
    }
  };

  ComponentView.prototype.setCssStyle = function(elem, property, value, defaultValue, unit) {
    if (value !== defaultValue) {
      return elem.$html.css(property, value + unit);
    } else {
      return elem.$html.css(property, '');
    }
  };
  ...
  ComponentView.prototype.setHyperlink = function(value) {
    var $elem;
    $elem = this.directives.$getElem(this.model.componentName);
    $elem.attr("data-hyperlink", value || void 0);
    if (this.isReadOnly) {
      if (value) {
        return $elem.find('a').attr('href', value).length || $elem.append($('<a>', {
          href: value
        }));
      } else {
        return $elem.find('a').remove();
      }
    }
  };
...
module.exports = Renderer = (function() {
  ...
  Renderer.prototype.setupComponentTreeListeners = function() {
    ...
    this.componentTree.componentHtmlChanged.add(this.componentHtmlChanged);
    return this.componentTree.componentDataChanged.add(this.componentDataChanged);
  };
  ...
  Renderer.prototype.removeComponentTreeListeners = function() {
    ...
    this.componentTree.componentHtmlChanged.remove(this.componentHtmlChanged);
    return this.componentTree.componentDataChanged.remove(this.componentDataChanged);
  };
  ...
  Renderer.prototype.componentDataChanged = function(model) {
    this.getOrCreateComponentView(model).updateData();
    return this.getOrCreateComponentView(model).updateInlineStylesData();
  };
